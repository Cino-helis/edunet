...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <div>
                <h2 class="fw-bold mb-1">Modifier l'Étudiant</h2>
                <p class="text-muted mb-0">{{ $etudiant->nom_complet }}</p>
            </div>
        </div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            @error('password')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Minimum 8 caractères si vous souhaitez modifier</small>
                        </div>
                    </div>
