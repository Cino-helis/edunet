...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <div>
                <h2 class="fw-bold mb-1">Créer une Filière</h2>
                <p class="text-muted mb-0">Ajouter une nouvelle filière au système</p>
            </div>
        </div>
                ...
                <form action="{{ route('admin.filieres.store') }}" method="POST">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-primary px-4">
                            <i class="bi bi-check-circle me-2"></i>Créer la filière
                        </button>
